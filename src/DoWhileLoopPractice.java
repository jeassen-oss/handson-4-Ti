...
public class DoWhileLoopPractice {
    public static void main(String[] args) {
        ...
        do {
            ...
            choice = 2; // simulasi user memilih exit
        } while (choice != 2);
        ...
        do {
            attempts++;
            if (attempts == 2) {
                inputValue = 7; // simulasi valid input
            }
        ...
        do {
            ...
            if (!enteredPassword.equals(correctPassword) && attemptCount < maxAttempts) {
                enteredPassword = "secret123"; // simulasi benar di attempt ke-2
            }
